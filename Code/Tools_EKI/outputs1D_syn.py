...
sio.savemat('./Results_Syn/FlowRates_pred_Equi_syn.mat', {'K_values':k_en,'C_values':c_en,'R_int':R_I_en,'R_ext':R_E_en, 'FlowRates_Equi':Fluxes})
#sio.savemat('Fluxes_pred_Equi_syn2.mat', {'Fluxes_Equi':Fluxes})
